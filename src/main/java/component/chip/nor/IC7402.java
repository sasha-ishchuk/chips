...
public class IC7402 extends ChipComponent {
    ...
    public List<Pin> setDefaultPins() {
        ...
        defaultPins.add(new Pin(1, PinState.UNKNOWN, PinType.OUT));
        ...
        defaultPins.add(new Pin(8, PinState.UNKNOWN, PinType.IN));
        ...
        defaultPins.add(new Pin(13, PinState.UNKNOWN, PinType.OUT));
        return defaultPins;
    }
