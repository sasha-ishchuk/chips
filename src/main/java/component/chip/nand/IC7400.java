...
public class IC7400 extends ChipComponent{
    ...
    public IC7400() {
        ...
        this.logicMatrix = new IC7400LogicMatrix();
        this.chipType = ChipType.IC7400;
    }
    ...
    public List<Pin> setDefaultPins() {
        ...
        defaultPins.add(new Pin(3, PinState.UNKNOWN, PinType.OUT));
        ...
        defaultPins.add(new Pin(11, PinState.UNKNOWN, PinType.OUT));
        defaultPins.add(new Pin(12, PinState.UNKNOWN, PinType.IN));
